...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        line->setGeometry(QRect(140, 10, 20, 71));
        ...
        lcdNumberVel = new QLCDNumber(frame_5);
        lcdNumberVel->setObjectName(QStringLiteral("lcdNumberVel"));
        lcdNumberVel->setGeometry(QRect(10, 40, 311, 141));
        lcdNumberVel->setStyleSheet(QStringLiteral("background-color: rgb(217, 217, 217);"));
        lcdNumberVel->setFrameShape(QFrame::Panel);
        lcdNumberVel->setFrameShadow(QFrame::Sunken);
        lcdNumberVel->setSmallDecimalPoint(true);
        lcdNumberVel->setDigitCount(4);
        lcdNumberVel->setSegmentStyle(QLCDNumber::Flat);
        lcdNumberVel->setProperty("value", QVariant(0));
